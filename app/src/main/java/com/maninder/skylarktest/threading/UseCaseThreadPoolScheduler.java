package com.maninder.skylarktest.threading;
...
public class UseCaseThreadPoolScheduler implements UseCaseScheduler {
    ...
    /**
     * This allow us to have a thread to run when we need some Background work.
     */
    ...
    /**
     * ThreadPoolExecutor is an implementation of the ExecutorService Service.
     * The ThreadPoolExecutor executes the given task(Callback or Runnable) using one of its internally pooled threads.
     */
